...
const TRANSLATIONS = {
  en: {
    ...
    edu_bsc_thesis: 'Thesis: Target Recognition and Tracking for Autonomous Systems',
    lang_name:  'English',
    ...
    proj1_title: 'IREC 2025 & 2026 (USA)',
    ...
    proj2_title: 'TEKNOFEST — High Altitude Rocket 2022-2023-2024',
    ...
    hw_tag: '04 / Hardware Designs',
    hw_title: 'Professional Hardware Projects',
    hw1_title: 'Autonomous Flight Computer – TH753',
    hw1_sub: 'STM32H753 MCU & 4-Layer Design',
    hw1_desc: '3X IMU, 2X Barometer, 2X Magnetometer, 10/100 Ethernet Interface.',
    hw1_desc_long: '<strong>Features:</strong><br>• STM32H753 MCU<br>• 3X IMU Sensor, 2X Barometer, 2X Magnetometer<br>• 10/100 Ethernet Interface<br>• 4-Layer Impedance Controlled Design<br>• Interfaces: I2C – SPI – UART – USB – ETHERNET – CAN – ADC',
    hw2_title: 'Communication Module - EX868',
    hw2_sub: 'XBEE-868 Based RF Module',
    hw2_desc: '10/80 kbps RF data rate, 10+ Km Communication Range.',
    hw2_desc_long: '<strong>Features:</strong><br>• XBEE-868 Communication Module<br>• 10/80 kbps RF Data Rate<br>• 10+ Km Communication Range<br>• WIFI Control & Configuration<br>• Point to Multipoint DigiMesh',
    hw3_title: 'Smart Switch 140',
    hw3_sub: 'ESP32 Controlled Smart Power Switch',
    hw3_desc: '3S – 6S Input Voltage, 140A Peak Current, 80A Continuous Current.',
    hw3_desc_long: '<strong>Features:</strong><br>• ESP32 Controlled Smart Power Switch<br>• 3S – 6S Input Voltage<br>• 140A Peak Current / 80A Continuous Current<br>• Bluetooth Control<br>• WIFI Control',
    hw4_title: 'PDB_V2',
    hw4_sub: 'Pixhawk Connector Standard PDB',
    hw4_desc: '4-Layer Special Design for High Current, 260A Peak Current.',
    hw4_desc_long: '<strong>Features:</strong><br>• 4-Layer Special Design for High Current<br>• Pixhawk Connector Standard<br>• 3S – 12S Input Voltage<br>• 260A Peak Current / 180A Continuous Current<br>• Adjustable Wide Output Voltage<br>• Analog & Digital Current, Voltage and Temperature Sensors',
    hw5_title: 'PDB_V1',
    hw5_sub: 'High Current Power Distribution Board',
    hw5_desc: '3S – 12S Input Voltage, 260A Peak Current, Digital Sensors.',
    hw5_desc_long: '<strong>Features:</strong><br>• 4-Layer Special Design for High Current<br>• 3S – 12S Input Voltage<br>• 260A Peak Current / 180A Continuous Current<br>• Adjustable Output Voltage<br>• Digital Current Voltage Sensor',
    hw6_title: 'Ethernet Switch & Dual USB Hub',
    hw6_sub: 'Jetson Nano Carrier Board Compatible',
    hw6_desc: '10/100/1000 Ethernet Switch, 2x 4-Slave USB 2.0 HUB.',
    hw6_desc_long: '<strong>Features:</strong><br>• Jetson Nano Carrier Board Compatible<br>• 3S – 8S Input Voltage<br>• 4-Layer Impedance Controlled Design<br>• 10/100/1000 Ethernet Switch<br>• 2x 4-Slave USB 2.0 HUB',
    hw7_title: 'Multi Power Board',
    hw7_sub: 'Independently Adjustable Multi-Output Power Board',
    hw7_desc: '3S – 12S Input Voltage, 60A Peak Current, 40A Continuous Current.',
    hw7_desc_long: '<strong>Features:</strong><br>• Independently Adjustable Multi-Output Power Board<br>• 3S – 12S Input Voltage<br>• 60A Peak Current / 40A Continuous Current<br>• Adjustable Output Voltage<br>• Digital Current Voltage Sensor<br>• I2C Interface',

      skills_tag:   '05 / Skills',
  ...
  tr: {
    ...
    proj2_title: 'TEKNOFEST — Yüksek İrtifa Roket 2022-2023-2024',
    ...
    hw_tag: '04 / Donanım Tasarımları',
    hw_title: 'Profesyonel Donanım Projeleri',
    hw1_title: 'Otonom Uçuş Bilgisayarı – TH753',
    hw1_sub: 'STM32H753 MCU & 4 Katman Tasarım',
    hw1_desc: '3X IMU, 2X Barometre, 2X Manyetometre, 10/100 Ethernet Arayüzü.',
    hw1_desc_long: '<strong>Özellikler:</strong><br>• STM32H753 MCU<br>• 3X IMU Sensörü, 2X Barometre, 2X Manyetometre<br>• 10/100 Ethernet Arayüzü<br>• 4 Katman Empedans Kontrollü Tasarım<br>• Arayüzler: I2C – SPI – UART – USB – ETHERNET – CAN – ADC',
    hw2_title: 'Haberleşme Modülü - EX868',
    hw2_sub: 'XBEE-868 Tabanlı RF Modül',
    hw2_desc: '10/80 kbps RF veri Hızı, 10 Km Üzeri İletişim Menzili.',
    hw2_desc_long: '<strong>Özellikler:</strong><br>• XBEE-868 Haberleşme Modülü<br>• 10/80 kbps RF veri Hızı<br>• 10 Km Üzeri İletişim Menzili<br>• WIFI Kontrol & Ayarlama<br>• Point to Multipoint DigiMesh',
    hw3_title: 'Smart Switch 140',
    hw3_sub: 'ESP32 Kontrolcülü Akıllı Güç Anahtarı',
    hw3_desc: '3S – 6S Giriş Voltajı, 140A Tepe Akımı, 80A Sürekli Akım.',
    hw3_desc_long: '<strong>Özellikler:</strong><br>• ESP32 Kontrolcülü Akıllı Güç Anahtarı<br>• 3S – 6S Giriş Voltajı<br>• 140A Tepe Akımı / 80A Sürekli Akım<br>• Bluetooth Kontrol<br>• WIFI Kontrol',
    hw4_title: 'PDB_V2',
    hw4_sub: 'Pixhawk Connector Standard PDB',
    hw4_desc: '4 Katmanlı Yüksek Akım için Özel Tasarım, 260A Tepe Akımı.',
    hw4_desc_long: '<strong>Özellikler:</strong><br>• 4 Katmanlı Yüksek Akım için Özel Tasarım<br>• Pixhawk Connector Standard<br>• 3S – 12S Giriş Voltajı<br>• 260A Tepe Akımı / 180A Sürekli Akım<br>• Ayarlanabilir Geniş Çıkış Gerilimi<br>• Analog & Dijital Akım, Gerilim ve Sıcaklık Sensörleri',
    hw5_title: 'PDB_V1',
    hw5_sub: 'Yüksek Akım Güç Dağıtım Kartı',
    hw5_desc: '3S – 12S Giriş Voltajı, 260A Tepe Akımı, Dijital Sensörler.',
    hw5_desc_long: '<strong>Özellikler:</strong><br>• 4 Katmanlı Yüksek Akım için Özel Tasarım<br>• 3S – 12S Giriş Voltajı<br>• 260A Tepe Akımı / 180A Sürekli Akım<br>• Ayarlanabilir Çıkış Gerilimi<br>• Dijital Akım Gerilim Sensörü',
    hw6_title: 'Ethernet Switch & Dual USB Hub',
    hw6_sub: 'Jetson Nano Carrier Board Uyumlu',
    hw6_desc: '10/100/1000 Ethernet Switch, 2 Adet 4 Slave USB 2.0 HUB.',
    hw6_desc_long: '<strong>Özellikler:</strong><br>• Jetson Nano Carrier Board Uyumlu<br>• 3S – 8S Giriş Voltajı<br>• 4 Katman Empedans Kontrollü Tasarım<br>• 10/100/1000 Ethernet Switch<br>• 2 Adet 4 Slave USB 2.0 HUB',
    hw7_title: 'Multi Power Board',
    hw7_sub: 'Bağımsız Ayarlanabilir Çok Çıkışlı Güç Kartı',
    hw7_desc: '3S – 12S Giriş Voltajı, 60A Tepe Akımı, 40A Sürekli Akım.',
    hw7_desc_long: '<strong>Özellikler:</strong><br>• Bağımsız Ayarlanabilir Çok Çıkışlı Güç Kartı<br>• 3S – 12S Giriş Voltajı<br>• 60A Tepe Akımı / 40A Sürekli Akım<br>• Ayarlanabilir Çıkış Gerilimi<br>• Dijital Akım Gerilim Sensörü<br>• I2C Arayüzü',

      skills_tag:   '05 / Yetenekler',
